...
export default defineComponent({
  ...
  setup(){
    ...
    const editar= (objetoId,t) => {
      show.value = false;
      objeto.value = {};
      const {id, nombre, detalles, preparacion, ejecucion, estado, idMusculoPrincipal, idMusculoSecundario, idEquipamiento,idCategoria} = ejercicios.value.find( ejercicio => ejercicio.id === objetoId )
